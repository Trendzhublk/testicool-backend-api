    ...
    <div class="email-wrapper">
        ...
        <div class="content">
            ...
            <div class="message">
                ...
                @else
                    We couldn't complete your payment{{ $reason ? ' (' . $reason . ')' : '' }}. Please try again or
                    contact support.
                @endif
            </div>
            ...
            <div class="message" style="text-align: center; margin-top: 30px; font-size: 14px;">
                If you have any questions about your payment or order, please contact us at
